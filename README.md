...
| 회원가입 플로우 | 로그인 플로우 |
| :---: | :---: |
| <img src="유저플로우 1.png" width="400" /> | <img src="유저플로우 2.png" width="400" /> |
| **약관 동의 및 계정 생성** | **스플래시 화면 및 로그인 진행** |

| 사진 업로드 플로우 | 마이페이지 및 설정 |
| :---: | :---: |
| <img src="유저플로우 3.png" width="400" /> | <img src="유저플로우 4.png" width="400" /> |
...
| :---: | :---: | :---: | :---: |
| <img src="메인화면.jpg" width="200" /> | <img src="로그인화면.jpg" width="200" /> | <img src="로딩화면.jpg" width="200" /> | <img src="결과화면.jpg" width="200" /> |
